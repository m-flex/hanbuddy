...
- [x] **VOCAB-03**: User can practice vocabulary through cloze (fill-in-the-blank) exercises in sentence context
...
- [x] **LIST-02**: User can practice listening through multiple-choice exercises (hear audio, select answer)
