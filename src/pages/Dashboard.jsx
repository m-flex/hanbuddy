...
import { Play, Trophy, Target, Star, Zap, BarChart3, Calendar, MessageSquare } from 'lucide-react'
import { getLevel, getDailyStreak } from '../store/progress'
import { ACHIEVEMENTS, STAGES } from '../data/korean'
    ...
    >
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-slate-400 text-lg">
          Master Korean vocabulary and grammar step by step
        </p>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-3 mb-10">
        ...
        <Link to="/sentences">
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-purple-500/10 border border-purple-500/30 text-purple-400 text-sm font-medium cursor-pointer hover:bg-purple-500/20 transition-colors">
